export { makeGetCoordinateFromLocate } from './get-coordinate-factory';
export { makeGetWeather } from './get-weather-factory';
export { makeSaveWeather } from './save-weather-factory';
